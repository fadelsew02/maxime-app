                              ...
                              if (printWindow) {
                                const htmlContent = `
                                  ...
                                  <html>
                                    ...
                                    <body>
                                      <div class="header">
                                        <h1>Société Nationale d'Essai et de Recherche des Travaux Publics (SNERTP)</h1>
                                        <h2>Rapport d'Essai Avisé</h2>
                                      </div>
                                      <div class="info">
                                      ...
                                      <div class="footer">
                                        <p>Ce document a été avisé électroniquement par le Directeur SNERTP</p>
                                        <p>Rapport original : ${selectedRapport.file}</p>
                                      </div>
                                      <div style="text-align: center;">
                                        <button onclick="window.print()" class="print-button">📄 Imprimer / Enregistrer en PDF</button>
                                        <p style="margin-top: 10px; font-size: 12px; color: #666;">Utilisez Ctrl+P ou Cmd+P puis sélectionnez "Enregistrer au format PDF"</p>
                                      </div>
                                    </body>
                                  </html>
                                `;
