"""
Django settings for SNERTP Laboratory Management System.
"""
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='snertp.onrender.com').split(",")
...
# CORS Configuration - Mode permissif pour développement
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@snertp.bj')
